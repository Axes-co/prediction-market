...
function InstagramIcon() {
  return (
    <svg className="size-[18px]" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs><clipPath id="ig-clip"><rect width="20" height="20" fill="currentColor" /></clipPath></defs>
    </svg>
  )
}
    ...
    <footer className="mt-12 border-t bg-background">
      <div className="container mx-auto flex flex-col gap-10 py-10">
        ...
        <div className="flex flex-col gap-2">
          <IntentPrefetchLink href="/" className="flex items-center gap-2 text-xl font-medium text-foreground transition-opacity hover:opacity-80">
            <SiteLogoIcon
        ...
        {/* Main Grid: Categories | Social | Site Links */}
