                        ...
                        : previewUrl
                          ? (
                              <div style={{ height: `${height * Math.min(1, 320 / width)}px` }}>
                                <iframe title={t('Embed preview')} src={previewUrl} width={width} height={height} frameBorder={0} scrolling="no" style={{ border: 'none', display: 'block', borderRadius: '16px', overflow: 'hidden', transform: `scale(${Math.min(1, 320 / width)})`, transformOrigin: 'left top' }} />
                              </div>
                            )
                          : (
