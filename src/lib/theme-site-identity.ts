...
const DEFAULT_SITE_DESCRIPTION_FALLBACK = 'Prediction Markets'
const DEFAULT_SITE_LOGO_SVG_FALLBACK = `
<svg viewBox="0 0 113 81" xmlns="http://www.w3.org/2000/svg">
  <text x="56.5" y="52" text-anchor="middle" font-family="system-ui, -apple-system, sans-serif" font-weight="700" font-size="40" fill="currentColor">AX</text>
</svg>
`
